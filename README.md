...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bj4rwgm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bj4rwgm.containers.anotherwebservice.com/
...
```
git clone git@github.com:marcelstange/container-bj4rwgm.git
cd container-bj4rwgm
```
...
```
docker attach container-bj4rwgm
```
